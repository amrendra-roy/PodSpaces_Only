...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
A Common frame for me that will provide an interface to calculate investment facilities for any bank. Any IT company can use this in swift project as plug and play.
                       DESC

  s.homepage         = 'https://github.com/amrendra-roy/InvestmentSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'amrendra.roy17@gmail.com' }
